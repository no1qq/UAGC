...
public final class CheckResult {
    ...
    private static final CheckResult PASSED = new CheckResult(false, 0.0D, "", Collections.emptyMap(), false);
    ...
    private CheckResult(boolean flagged, double severity, String summary, Map<String, String> details, boolean requestSetback) {
    ...
    public static final class Builder {
        ...
        public CheckResult build() {
            return new CheckResult(true, severity, summary, Collections.unmodifiableMap(details), requestSetback);
        }
    }
}
